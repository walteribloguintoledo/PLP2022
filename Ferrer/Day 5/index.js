...
$(document).ready(function () {
	$.getScript("./app/assets/js/validation.js").fail(function () {
		alert("Something went wrong!");
	});

	$.Mustache.options.warnOnMissingTemplates = true;

	$.Mustache.load("./app/template/templates.html").done(function () {
		Path.map(routes.login).to(function () {
			$("#target").html("").append($.Mustache.render("login"));

			$.getScript("./app/assets/js/login.js").fail(function () {
				alert("Something went wrong!");
			});
		});
		...
		Path.map(routes.signup).to(function () {
			...
			$.getScript("./app/assets/js/signup.js").fail(function () {
				alert("Something went wrong!");
			});
		});
		...
		Path.map(routes.home).to(function () {
			...
			$(document).ready(function () {
				...
				$.getScript("./app/assets/js/editInfo.js").fail(function () {
					alert("Something went wrong!");
				});

				$.getScript("./app/assets/js/deleteAccount.js").fail(function () {
					alert("Something went wrong!");
				});
